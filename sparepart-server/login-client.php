...
$query = "SELECT clientId, status FROM client WHERE clientPassword = '$password' AND clientUsername = '$username' LIMIT 1";
...
if ($rows == 1)
{
   if ($user_status != "Blocked")
   {
      ...
      $_SESSION['logged_user_info_type'] = "client"; // Initializing Session
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                ...
                                <p class="text-muted-50">Don't have an account? <a href="create-client.php" class="text-muted ml-1"><b>Sign Up</b></a></p>
                             </div> <!-- end col -->
                        </div>
                        <!-- end row -->
