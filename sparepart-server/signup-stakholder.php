...
if(isset($_POST['submit']))
{
    ...
    $query = "INSERT INTO shareholder(shareholderName, shareholderEmail, shareholderPhonenumber, shareholderUsername, shareholderPassword, date, status) VALUES ('$names','$email', '$phone', '$username', '$password', '$date', 'Active')";
    if($conn->query($query)){
        header("Location: signup-stakholder.php?success");
    }else {
        header("Location: signup-stakholder.php?error");
    }
}
?>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                              ...
                              <?php } ?>
                                ...
                                <form method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="tel" id="phone" required placeholder="Enter your Telephone" name="phone">
                                    </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-muted-50">Already have account?  <a href="login-stakehoder.php" class="text-muted ml-1"><b>Sign In</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
