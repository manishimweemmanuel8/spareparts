                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-lg-right mt-3 mt-lg-0" style="float: left">
                                                <a href="client-paid-report.php" class="btn btn-primary waves-effect waves-light"><i class=""></i> Print</a>
                                            </div>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <?php $query = "SELECT * FROM order_tb where client=$user_id AND status='paid' ORDER BY orderDate DESC";
