                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-lg-right mt-3 mt-lg-0" style="float: left; margin-bottom:2em">
                                                <a href="view-approved-shareholder-report.php" class="btn btn-primary waves-effect waves-light"><i class=""></i> Print</a>
                                            </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-centered table-borderless table-hover mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                        $query = "SELECT * FROM order_tb where shareholder=$user_id AND delivery_status='Approved' ORDER BY delivery_status ASC";
