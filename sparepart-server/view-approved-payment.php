                ...
                <div class="content">
                    ...
                    <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">List of Approved payment</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                    ...
                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="text-lg-right mt-3 mt-lg-0" style="float: left">
                                                <a href="view-approved-payment-report.php" class="btn btn-primary waves-effect waves-light"><i class=""></i> Print</a>
                                            </div>
                       ...
                       <div class="row">
                                ...
                                $query = "SELECT * FROM payment where status='Approve'";
