...
if(isset($_GET['status2']))
{
    ...
    $query = "UPDATE order_tb SET delivery_status='Delivered', comment = 'You confirmed that you received the product,  Thank you for using autoparts' WHERE client='$user_id' AND orderNo = '$s2Id'";
 
    if($query = $conn->query($query)){
        header("Location: notifications.php?success");
    } else {
        header("Location: notifications.php?error");
    }
}
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- end page title --> 
                         <?php if(isset($_GET['success'])){ ?>
                              <div class="alert alert-success alert-dismissable"><button type="button" data-dismiss="alert" aria-hidden="true" class="close">×</button></span><strong>Successfully!</strong> Product Delivered</div>
                              <?php } ?>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-lg-right mt-3 mt-lg-0" style="float: left">
                                                <a href="notifications-report.php" class="btn btn-primary waves-effect waves-light"><i class=""></i> Print</a>
                                            </div>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <?php $query = "SELECT * FROM order_tb where client=$user_id ORDER BY orderDate DESC";
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    <?php if($row['delivery_status'] == "Approved") { ?>
                                                    <a href="notifications.php?status2=<?php echo $row['orderNo'] ?>" class="badge badge-success">Comfirm Delivery</a>
                                                    <?php } ?>
                                                    </td>
                                                <?php        
                                                }
