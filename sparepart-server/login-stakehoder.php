...
$query = "SELECT shareholderId, status FROM shareholder WHERE shareholderPassword = '$password' AND shareholderUsername = '$username' LIMIT 1";
...
if ($rows == 1)
{
   if ($user_status != "Blocked")
   {
      ...
      $_SESSION['logged_user_info_type'] = "shareholder"; // Initializing Session
...
<head>
        <meta charset="utf-8" />
        <title>UBold - Responsive Admin Dashboard </title>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <?php if(isset($_GET['success'])){ ?>
                              ...
                              <?php } ?>
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="login-manager.php"><h5 class="mt-3 text-muted">Sign as Manager</h5></a>
                                </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p> <a href="pages-recoverpw.html" class="text-muted-50 ml-1">Forgot your password?</a></p>
                                <p class="text-muted-50">Don't have an account? <a href="signup-stakholder.php" class="text-muted ml-1"><b>Sign Up</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
